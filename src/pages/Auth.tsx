...
const Auth = () => {
  ...
  async function signInWithGoogle() {
    ...
    try {
      ...
      // Get the current URL to handle redirect
      ...
      if (error) {
        ...
        // Toast will be shown after successful redirect back
      }
    } catch (error) {
      toast.error("An unexpected error occurred");
      console.error(error);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-4 text-center text-sm text-gray-500">
          <p>Having trouble signing in? Make sure you've set up your Google OAuth credentials correctly in Supabase.</p>
        </div>
      </div>
    </div>
  );
